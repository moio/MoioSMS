package org.papervision3d.core.render.data
{
    ...
    final public class QuadTreeNode extends Object
    {
        ...
        {
            var _loc_4:RenderableListItem = null;
            ...
            while (this.render_center_index < this.render_center_length)
            {
                ...
                _loc_4 = this.center[this.render_center_index];
                if (_loc_4.screenZ < param1)
                {
                    break;
                }
                this.render_other(_loc_4.screenZ, param2, param3);
                _loc_4.render(param2, param3);
                param2.viewPort.lastRenderList.push(_loc_4);
                var _loc_5:String = this;
                _loc_5.render_center_index = this.render_center_index++;
            }
