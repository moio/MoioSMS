package it.vodafone
{
    ...
    public class Infoconto extends Canvas implements IBindingClient
    {
        private var _tipoCredito:int;
        ...
        private var _1835020882_titolo:String = "Credito / Infoconto";
        ...
        public var _Infoconto_RemoveChild1:RemoveChild;
        public var _Infoconto_RemoveChild2:RemoveChild;
        public var _Infoconto_RemoveChild3:RemoveChild;
        ...
        public var _Infoconto_AddChild1:AddChild;
        var _bindings:Array;
        public var _Infoconto_SetStyle1:SetStyle;
        public var _Infoconto_SetStyle2:SetStyle;
        public var _Infoconto_SetStyle3:SetStyle;
        private var _documentDescriptor_:UIComponentDescriptor;
        private var _embed_mxml_______img_v1_expanded_r_jpg_1796344049:Class;
        private static var _watcherSetupUtil:IWatcherSetupUtil;

        public function Infoconto()
        {
            ...
            this._embed_mxml_______img_v1_bg_infoconto_png_1295411645 = Infoconto__embed_mxml_______img_v1_bg_infoconto_png_1295411645;
            this._embed_mxml_______img_v1_expanded_over_png_360079281 = Infoconto__embed_mxml_______img_v1_expanded_over_png_360079281;
            this._embed_mxml_______img_v1_expanded_png_1764667771 = Infoconto__embed_mxml_______img_v1_expanded_png_1764667771;
            this._embed_mxml_______img_v1_expanded_r_jpg_1796344049 = Infoconto__embed_mxml_______img_v1_expanded_r_jpg_1796344049;
            this._embed_mxml_______img_v1_reload_over_png_1513002865 = Infoconto__embed_mxml_______img_v1_reload_over_png_1513002865;
            this._embed_mxml_______img_v1_reload_png_264908037 = Infoconto__embed_mxml_______img_v1_reload_png_264908037;
            this._bindings = [];
            this._watchers = [];
            ...
            this.states = [this._Infoconto_State1_c()];
            this._Infoconto_Glow1_i();
            this._Infoconto_Sequence1_i();
            this._Infoconto_Sequence2_i();
            this.addEventListener("click", this.___Infoconto_Canvas1_click);
            this.addEventListener("addedToStage", this.___Infoconto_Canvas1_addedToStage);
            return;
        }// end function
        ...
        private function init() : void
        {
            ...
            ServerBridge.getServerBridgeInstance().addEventListener(ServerBridge.INFOCONTO_LOADED, this.updateDisplay);
            ServerBridge.getServerBridgeInstance().addEventListener(ServerBridge.LOADING_INFOCONTO, this.displayLoading);
            return;
        }// end function

        private function _Infoconto_AddChild1_i() : AddChild
        {
            var _loc_1:* = new AddChild();
            this._Infoconto_AddChild1 = _loc_1;
            _loc_1.position = "lastChild";
            _loc_1.targetFactory = new DeferredInstanceFromFunction(this._Infoconto_Text1_i);
            BindingManager.executeBindings(this, "_Infoconto_AddChild1", this._Infoconto_AddChild1);
            return _loc_1;
        }// end function
        ...
        private function displayLoading(event:Event = null) : void
        {
            this._testo = "Loading...";
            this._ora = "";
            this._titolo = "Infoconto";
            return;
        }// end function

        private function _Infoconto_SetStyle1_i() : SetStyle
        {
            var _loc_1:* = new SetStyle();
            this._Infoconto_SetStyle1 = _loc_1;
            _loc_1.name = "overSkin";
            _loc_1.value = this._embed_mxml_______img_v1_expanded_r_jpg_1796344049;
            BindingManager.executeBindings(this, "_Infoconto_SetStyle1", this._Infoconto_SetStyle1);
            return _loc_1;
        }// end function
        ...
        private function _Infoconto_Text1_i() : Text
        {
            var _loc_1:* = new Text();
        ...
        private function _Infoconto_Fade2_c() : Fade
        {
            var _loc_1:* = new Fade();
            _loc_1.duration = 400;
            return _loc_1;
        ...
        private function _Infoconto_RemoveChild1_i() : RemoveChild
        {
            var _loc_1:* = new RemoveChild();
            this._Infoconto_RemoveChild1 = _loc_1;
            BindingManager.executeBindings(this, "_Infoconto_RemoveChild1", this._Infoconto_RemoveChild1);
            return _loc_1;
        }// end function

        private function _Infoconto_State1_c() : State
        {
            var _loc_1:* = new State();
            _loc_1.name = "info";
            _loc_1.overrides = [this._Infoconto_RemoveChild1_i(), this._Infoconto_RemoveChild2_i(), this._Infoconto_RemoveChild3_i(), this._Infoconto_AddChild1_i(), this._Infoconto_SetStyle1_i(), this._Infoconto_SetStyle2_i(), this._Infoconto_SetStyle3_i()];
            return _loc_1;
        }// end function
        ...
        private function _Infoconto_SetPropertyAction1_c() : SetPropertyAction
        {
        ...
        public function ___Infoconto_Canvas1_click(event:MouseEvent) : void
        {
            this.clickMore(event);
            return;
        }// end function

        private function _Infoconto_Sequence2_i() : Sequence
        {
            var _loc_1:* = new Sequence();
            this.effetto_scompare = _loc_1;
            _loc_1.children = [this._Infoconto_Fade2_c()];
            return _loc_1;
        }// end function

        private function _Infoconto_Fade1_c() : Fade
        {
            var _loc_1:* = new Fade();
            _loc_1.duration = 200;
            return _loc_1;
        ...
        private function _Infoconto_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _Infoconto_RemoveChild1.target = param1;
                return;
            }// end function
            , "_Infoconto_RemoveChild1.target");
            result[0] = binding;
            binding = new Binding(this, function () : DisplayObject
            {
                return label2;
            ...
            , function (param1:DisplayObject) : void
            {
                _Infoconto_RemoveChild2.target = param1;
                return;
            }// end function
            , "_Infoconto_RemoveChild2.target");
            result[1] = binding;
            binding = new Binding(this, function () : DisplayObject
            {
                return textarea1;
            ...
            , function (param1:DisplayObject) : void
            {
                _Infoconto_RemoveChild3.target = param1;
                return;
            }// end function
            , "_Infoconto_RemoveChild3.target");
            result[2] = binding;
            ...
            {
                _Infoconto_AddChild1.relativeTo = param1;
                return;
            }// end function
            , "_Infoconto_AddChild1.relativeTo");
            result[3] = binding;
            ...
            {
                _Infoconto_SetStyle1.target = param1;
                return;
            }// end function
            , "_Infoconto_SetStyle1.target");
            result[5] = binding;
            binding = new Binding(this, function () : IStyleClient
            {
                return button1;
            ...
            , function (param1:IStyleClient) : void
            {
                _Infoconto_SetStyle2.target = param1;
                return;
            }// end function
            , "_Infoconto_SetStyle2.target");
            result[6] = binding;
            binding = new Binding(this, function () : IStyleClient
            {
                return button1;
            ...
            , function (param1:IStyleClient) : void
            {
                _Infoconto_SetStyle3.target = param1;
                return;
            }// end function
            , "_Infoconto_SetStyle3.target");
            result[7] = binding;
            binding = new Binding(this, function () : String
            {
                var _loc_1:* = _testo;
        ...
        private function _Infoconto_bindingExprs() : void
        {
        ...
        {
            var target:Infoconto;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(this._documentDescriptor_);
            var bindings:* = this._Infoconto_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_it_vodafone_InfocontoWatcherSetupUtil");
        ...
        private function _Infoconto_Sequence1_i() : Sequence
        {
            var _loc_1:* = new Sequence();
            this.effetto_appare = _loc_1;
            _loc_1.children = [this._Infoconto_SetPropertyAction1_c(), this._Infoconto_Pause1_c(), this._Infoconto_Fade1_c()];
            return _loc_1;
        }// end function
        ...
        private function _Infoconto_Pause1_c() : Pause
        {
        ...
        private function _Infoconto_RemoveChild3_i() : RemoveChild
        {
            var _loc_1:* = new RemoveChild();
            this._Infoconto_RemoveChild3 = _loc_1;
            BindingManager.executeBindings(this, "_Infoconto_RemoveChild3", this._Infoconto_RemoveChild3);
            return _loc_1;
        }// end function

        private function _Infoconto_SetStyle3_i() : SetStyle
        {
            var _loc_1:* = new SetStyle();
            this._Infoconto_SetStyle3 = _loc_1;
            _loc_1.name = "upSkin";
            _loc_1.value = this._embed_mxml_______img_v1_expanded_r_jpg_1796344049;
            BindingManager.executeBindings(this, "_Infoconto_SetStyle3", this._Infoconto_SetStyle3);
            return _loc_1;
        }// end function
        ...
        private function _Infoconto_Glow1_i() : Glow
        {
            var _loc_1:* = new Glow();
        ...
        {
            if (ServerBridge.getServerBridgeInstance().credito == "")
            {
                this.update();
            }
            else
            {
                this._tipoCredito = ServerBridge.getServerBridgeInstance().tipoCredito;
                this.setCredito(ServerBridge.getServerBridgeInstance().credito, ServerBridge.getServerBridgeInstance().oraCredito);
            }
            return;
        }// end function
        ...
        private function update() : void
        {
            ...
            ServerBridge.getServerBridgeInstance().updateCredito(true);
            return;
        }// end function
        ...
        public function setCredito(param1:String, param2:String) : void
        {
            ...
            else if (this._tipoCredito == ServerBridge.VALORE_CREDITO)
            {
                this._testoEsteso = "Il traffico disponibile aggiornato alle " + param2 + " è " + param1.replace(".", ",") + " euro, IVA inclusa.";
                this._testo = param1.replace(".", ",") + "€";
                this._ora = "alle " + param2;
                this._titolo = "Infoconto";
            }
            else if (this._tipoCredito == ServerBridge.VALORE_INFOCONTO)
            {
                this._testoEsteso = "Il traffico non ancora fatturato aggiornato alle " + param2 + " è " + param1.replace(".", ",") + " euro, IVA esclusa.";
                this._testo = param1.replace(".", ",") + "€";
                this._ora = "alle " + param2;
                this._titolo = "Infoconto";
            }
        ...
        private function _Infoconto_SetStyle2_i() : SetStyle
        {
            var _loc_1:* = new SetStyle();
            this._Infoconto_SetStyle2 = _loc_1;
            _loc_1.name = "downSkin";
            _loc_1.value = this._embed_mxml_______img_v1_expanded_r_jpg_1796344049;
            BindingManager.executeBindings(this, "_Infoconto_SetStyle2", this._Infoconto_SetStyle2);
            return _loc_1;
        }// end function
        ...
        public function ___Infoconto_Canvas1_addedToStage(event:Event) : void
        {
            this.init();
            return;
        }// end function
        ...
        private function _Infoconto_RemoveChild2_i() : RemoveChild
        {
            var _loc_1:* = new RemoveChild();
            this._Infoconto_RemoveChild2 = _loc_1;
            BindingManager.executeBindings(this, "_Infoconto_RemoveChild2", this._Infoconto_RemoveChild2);
            return _loc_1;
        }// end function
        ...
        private function clickMore(event:MouseEvent) : void
        {
            ...
            dispatchEvent(new BannerClick(RemotePreferences.getInstance().getValue("infoconto_more_url")));
            return;
        }// end function
